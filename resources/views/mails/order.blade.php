			...
			<tr>
				<td>
					<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
						role="presentation"
						style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #00aa6c; margin-bottom: .5rem;" width="100%">
						<tbody>
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										class="row-content stack" role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; background-color: #00aa6c; width: 640px;"
										width="640">
										<tbody>
											<tr>
																	...
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tr>
																			<td class="divider_inner"
																				style="font-size: 1px; line-height: 1px; border-top: 4px solid #00aa6c;">
																				<span> </span></td>
																		</tr>
																	</table>
																</div>
											...
											<tr>
												<td class="column column-1"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="width:100%;background: #00aa6c; border-top-left-radius: .5rem; border-top-right-radius: .5rem;">
																<div align="center" class="alignment" style="line-height:10px">
                                                                    <a href="{{ $frontUrl }}" style="outline:none;" tabindex="-1" target="_blank"title="{{ $settings->name }}">
                                                                        <img 
																			src="{{ $message->embed(public_path('media/light-logo.png')) }}"
																			style="display: block; height: auto; border: 0; width: 100px; height:5.5rem; max-width: 100%;"
																			width="250" />
                                                                    </a>
                                                                </div>
															</td>
											...
											<tr>
												<td class="column column-1"
															...
															<td class="pad"
																...
																<div align="center" class="alignment"
																	style="line-height:10px"><a
																		...
																		target="_blank"><img
																			class="big"
																			src="{{ $message->embed(public_path('media/check.png')) }}"
																			style="display: block; height: 12rem; border: 0; width: auto;"
																			width="640" /></a></div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-bottom:30px;padding-left:40px;padding-right:40px;">
																<div style="font-family: Arial, sans-serif">
																	<div class=""
																		...
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
																			<span
																				style="font-size:30px;color:#2b303a;">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-bottom:5px;padding-left:40px;padding-right:40px;padding-top:5px;">
																<div style="font-family: sans-serif">
																	<div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
																		<p style="margin: 0; font-size: 15px; text-align: left;">
																			<span style="color:#808389;font-size:15px;line-height:180%">
                                                                                Under these Terms of Use, the payment processing services 
                                                                                for the Services provided are provided by {{$settings->name}} Limited.
                                                                            </span>
                                                                        </p>
																	</div>
																</div>
														...
														<tr>
															<td class="pad"
																...
																<div style="font-family: sans-serif">
																	<div class="" style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
																		<p style="margin: 0; font-size: 15px; text-align: left;">
																			<span style="color:#4e5461;font-size:15px;line-height:180%">
                                                                                Booking has been confirmed successfully . <br>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														width="100%">
														<tr>
															<td class="pad" style="padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom: 3rem;text-align:center;">
																<div align="center" class="alignment">
																	<a href="{{ $frontUrl }}/bookings" target="_blank" class="reset-button"
																		style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#00aa6c;border-radius:2px;width:14rem;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:12px;padding-bottom:12px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:15px;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                                        <span style="padding-left:25px;padding-right:25px;font-size:16px;display:inline-block;letter-spacing:normal;">
                                                                            <span style="margin: 0; word-break: break-word; line-height: 27px;">
                                                                                My Bookings
                                                                            </span>
                                                                        </span>
                                                                    </a>
						...
						<tbody>
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										class="row-content stack" role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; background-color: #00aa6c; width: 640px;border-bottom-left-radius: .5rem; border-bottom-right-radius: .5rem;"
										width="640">
										<tbody>
											<tr>
												<td class="column column-1"
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-bottom:5px;padding-left:10px;padding-right:10px;padding-top:28px;text-align:center;">
																<div align="center" class="alignment">
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tr>
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img
																						height="32"
																						src="{{ $message->embed(public_path('media/facebook2x.png')) }}"
																						style="display: block; height: auto; border: 0;"
																						title="Facebook"
																						width="32" /></a></td>
																			<td style="padding:0 10px 0 10px;"><a
																					href="{{ $settings->twetter }}"
																					target="_blank"><img
																						height="32"
																						src="{{ $message->embed(public_path('media/twitter2x.png')) }}"
																						style="display: block; height: auto; border: 0;"
																						title="Twitter"
																						width="32" /></a></td>
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img 
																						height="32"
																						src="{{ $message->embed(public_path('media/instagram2x.png')) }}"
																						style="display: block; height: auto; border: 0;"
																						title="Instagram"
																						width="32" /></a></td>
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img 
																						height="32"
																						src="{{ $message->embed(public_path('media/linkedin2x.png')) }}"
																						style="display: block; height: auto; border: 0;"
																						title="LinkedIn"
																						width="32" /></a></td>
																		</tr>
															...
															<td class="pad"
																...
																<div align="center" class="alignment">
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tr>
																			<td class="divider_inner"
																				style="font-size: 1px; line-height: 1px; border-top: 1px solid #01d587;">
																				<span> </span></td>
																		</tr>
																	</table>
																</div>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-bottom:20px;padding-left:40px;padding-right:40px;padding-top:5px;">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<span
																				style="color:#fff;font-size:12px;">{{ $settings->name }}
																				Copyright © {{ date('Y') }}</span></p>
																	</div>
																</div>
															</td>
														</tr>
